...
tf.app.flags.DEFINE_string('train_directory', train_dir + '/',
                           'Training data directory')
tf.app.flags.DEFINE_string('validation_directory', validate_dir + '/',
                           'Validation data directory')
tf.app.flags.DEFINE_string('output_directory', cnn_current + '/',
